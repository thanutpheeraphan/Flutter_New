...
class welcome_speech_day1_7 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text('พิธีเปิดการประชุมและกล่าวขอบคุณผู้สนับสนุน',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
            Text('25.03.20          - 13:30',  style: TextStyle(fontStyle: FontStyle.italic,fontSize: 15) , ) ,
            ...
            Text('พิธีเปิดการประชุมและกล่าวขอบคุณผู้สนับสนุน โดย คณบดีคณะวิศวกรรมศาสตร์ มหาวิทยาลัยพะเยา หรือผู้แทน '),Text(""),
            Text('Presenter',  style: GoogleFonts.notoSans(fontSize: 20),textAlign: TextAlign.start,),
            Container(
