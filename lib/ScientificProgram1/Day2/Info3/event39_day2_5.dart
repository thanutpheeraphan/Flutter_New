...
class event39_day2_5 extends StatelessWidget {
  @override
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(' ห้องที่ 3 (ชื่อเดิม Samet Ballroom) ',  style: GoogleFonts.notoSans(fontSize: 15)), Text(""),
            Text(""),
                    ...
                    children: <Widget>[Text('       '),Image.asset('assets/images/info3.png'),
                      Container(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text('     ประธานภาค : ผศ.ดร.รักติพงษ์ สหมิตรมงคล',  overflow: TextOverflow.ellipsis , maxLines: 1, style: GoogleFonts.notoSans(fontSize: 14))],
                        ),
                      ),
                    ],
                  ),
