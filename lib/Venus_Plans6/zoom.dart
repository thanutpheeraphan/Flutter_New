...
class _MyHomePageState extends State<zoom>{
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text("Zoom Manual",style: GoogleFonts.oswald(fontSize: 16,fontWeight: FontWeight.bold)),
          centerTitle: true,
  ...
  loadFromAssets() async {
    ...
    document = await PDFDocument.fromAsset("assets/zoom.pdf");
    setState(() {
      isLoading = false;
    });
  }
